...
async def healthz():
    return {
        ...
        "dependencies": {
            "tavily": "healthy" if TAVILY_API_KEY else "unknown",
            "serper": "healthy" if SERPER_API_KEY else "unknown",
            "portkey": "healthy" if PORTKEY_API_KEY else "unknown"
        }
    }
...
async def search(request: SearchRequest):
    ...
    # Return normalized failure if missing required keys
    missing_keys = []
