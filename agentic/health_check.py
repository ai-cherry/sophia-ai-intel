#!/usr/bin/env python3
"""
Health Check Implementation for agentic
...
async def comprehensive_health_check() -> HealthStatus:
    ...
    for service_name, service_url in dependent_services:
        if service_url and service_name != "agentic":  # Don't check self
...
def add_health_endpoints_to_app(app: FastAPI):
    ...
    async def quick_health_check():
        ...
        return {"status": "healthy", "service": "agentic"}
    ...
    async def readiness_check():
        ...
        return {"status": "ready", "service": "agentic"}
    
    @app.get("/health/live") 
    async def liveness_check():
        """Kubernetes liveness probe endpoint"""
        # Simple check to ensure service is alive
        return {"status": "alive", "service": "agentic"}
